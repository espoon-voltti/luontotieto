...
enum class DocumentType(
    ...
    @DatabaseValue("luontotieto:report") REPORT(fileExtension = FileExtension.PDF),
    @DatabaseValue("luontotieto:other") OTHER;
...
fun Handle.insertReportFile(data: ReportFileInput, user: AuthenticatedUser): UUID =
    createUpdate(
            """
...
fun Handle.getReportFileById(reportId: UUID, fileId: UUID): ReportFile =
    createQuery(
            """
...
fun Handle.deleteReportFile(reportId: UUID, fileId: UUID) {
