...
COMMENT ON COLUMN muut_huomioitavat_lajit_pisteet.koordinaatti_tarkkuus IS 'Havaintopaikan koordinaattien arvioitu heitto metreissä. Havaintojen paikalle määritelty karkea tarkkuus metreinä, esimerkiksi 1 metri tai 10 metriä.';
...
COMMENT ON COLUMN muut_huomioitavat_lajit_pisteet.selvitys_id IS 'Selvityksen yksilöllinen tunniste. Generoidaan automaattisesti.';
...
COMMENT ON COLUMN muut_huomioitavat_lajit_viivat.pvm IS 'Päivämäärä, jolloin viivakohde on määritelty tai arvio siitä.';
...
COMMENT ON COLUMN muut_huomioitavat_lajit_viivat.laji_luokitus IS 'Arvioitu  vapaamuotoinen luokituskuvaus, joka kuvaa viivakohteen arvoa tai merkitystä lajille. Esim. ”kulkuyhteys”, ”kriittinen yhteys lajin elinalueiden välillä”.';
...
COMMENT ON COLUMN muut_huomioitavat_lajit_viivat.pituus IS 'Viivan pituus metreinä';
...
COMMENT ON COLUMN muut_huomioitavat_lajit_viivat.selvitys_id IS 'Selvityksen yksilöllinen tunniste. Generoidaan automaattisesti.';
...
COMMENT ON COLUMN muut_huomioitavat_lajit_alueet.pvm IS 'Päivämäärä, jolloin alue on määritelty tai arvio siitä.';
...
COMMENT ON COLUMN muut_huomioitavat_lajit_alueet.laji_luokitus IS 'Arvioitu vapaamuotoinen luokituskuvaus, joka kuvaa alueen arvoa tai merkitystä lajille. Esim. ”lisääntymis- ja levähdyspaikka”, ”lajin ydinalue”, ”lajille soveltuva elinympäristö”, ”ruokailualue”.';
...
COMMENT ON COLUMN muut_huomioitavat_lajit_alueet.selvitys_id IS 'Selvityksen yksilöllinen tunniste. Generoidaan automaattisesti.';
