...
class GpkgWriterTest {
    private fun checkIsValidSchema(file: Path, tableDefinition: TableDefinition): Boolean {
        val dataStoreParams =
            mapOf(
        ...
        return tableDefinition.columns.all { column ->
            /**
             * Ignore viite column here since it is a corner case we support for importing the
             * existing report data and therefore it does not exist in the usual cases.
             */
